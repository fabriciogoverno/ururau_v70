...
class PainelUrurau(tk.Tk):
    ...
    def _carregar_thread(self):
        try:
            ...
            self._carregando_lista = False
            self.after(0, lambda e=e: self._set_status(f"Erro ao carregar: {e}"))
    ...
    def _coletar_thread(self):
        try:
            ...
            self.after(0, lambda e=e: self._set_status(f"Erro na coleta: {e}"))
            self.after(0, lambda e=e: messagebox.showerror("Erro na coleta", str(e)))
    ...
    def _copydesk_thread(self, pauta: dict):
        ...
        try:
            ...
            self.after(0, lambda e=e: self._set_status(f"Erro no copydesk: {e}"))
            self.after(0, lambda e=e: messagebox.showerror("Erro no Copydesk", str(e)))
    ...
    def _buscar_imagem_thread(self, pauta: dict):
        try:
            ...
            self.after(0, lambda e=e: self._set_status(f"Erro na imagem: {e}"))
            self.after(0, lambda e=e: messagebox.showerror("Erro na Imagem", str(e)))
    ...
    def _publicar_thread(self, pauta: dict, md: dict, rascunho: bool = True):
        ...
        try:
            ...
            self.after(0, lambda e=e: self._set_status(f"Erro no envio: {e}"))
    ...
    def _acao_historico(self):
        ...
        def _t():
            try:
                ...
                self.after(0, lambda e=e: (txt.insert("1.0", f"Erro: {e}"), txt.config(state="disabled")))
        threading.Thread(target=_t, daemon=True).start()
...
class JanelaPreview(tk.Toplevel):
    ...
    def _buscar_imagem_tema_thread(self, tema: str):
        ...
        try:
            ...
            self.after(0, lambda e=e: self._lbl_img.config(text=f"Erro na busca:\n{e}"))
            self.after(0, lambda e=e: messagebox.showerror("Erro", str(e), parent=self))
    ...
    def _iniciar(self):
        ...
        def _run():
            try:
                ...
                self.after(0, lambda e=e: self._append_log(f"[ERRO] {e}", "err"))
            finally:
