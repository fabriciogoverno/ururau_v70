...
v70-hotfix: importa executar_publicacao_playwright do form_filler para publicação CMS.
"""
...
# v70-hotfix: importa a função correta de publicação do form_filler
from ururau.publisher.form_filler import executar_publicacao_playwright as _publicar_async
